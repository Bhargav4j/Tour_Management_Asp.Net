...
public class DetailsModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(int id, CancellationToken cancellationToken = default)
    {
        try
        {
            _logger.LogInformation("Retrieving details for tour with ID: {TourId}", id);
        ...
        catch (Exception ex)
        {
            ...
            TempData["ErrorMessage"] = "An error occurred while retrieving the tour details. Please try again.";
            return RedirectToPage("./Index");
        }
    }
}
