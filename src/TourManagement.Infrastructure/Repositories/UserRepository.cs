...
public class UserRepository : IUserRepository
{
    ...
    public async Task<User?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error getting user by ID from database: {UserId}", id);
            throw;
        }
    }
    ...
    public async Task<User?> GetByEmailAsync(string email, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error getting user by email from database: {Email}", email);
            throw;
        }
    }
    ...
    public async Task UpdateAsync(User user, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error updating user in database: {UserId}", user.Id);
            throw;
        }
    }
    ...
    public async Task DeleteAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error deleting user from database: {UserId}", id);
            throw;
        }
    }
