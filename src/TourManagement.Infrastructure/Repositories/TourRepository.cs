...
public class TourRepository : ITourRepository
{
    ...
    public async Task<Tour?> GetByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error getting tour by ID from database: {TourId}", id);
            throw;
        }
    }
    ...
    public async Task UpdateAsync(Tour tour, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error updating tour in database: {TourId}", tour.Id);
            throw;
        }
    }
    ...
    public async Task DeleteAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error deleting tour from database: {TourId}", id);
            throw;
        }
    }
    ...
    public async Task<bool> ExistsAsync(int id, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error checking if tour exists: {TourId}", id);
            throw;
        }
    }
    ...
    public async Task<IEnumerable<Tour>> SearchAsync(string searchTerm, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Error searching tours: {SearchTerm}", searchTerm);
            throw;
        }
    }
